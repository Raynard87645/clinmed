...
//$db = mysqli_connect('localhost', 'root', '', 'sql5763372');
...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    $sql = "INSERT INTO users (id, username, firstname, lastname, email, password, title ) VALUES(?,?,?,?,?,?,?)";
		$stmtinsert = $db->prepare($sql);
		$result = $stmtinsert->execute([$id, $username, $firstname, $lastname, $email, $password, $title]);
